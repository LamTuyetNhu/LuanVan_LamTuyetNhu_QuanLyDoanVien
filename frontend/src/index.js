    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/BCH-DoanTruong" element={<App />}>
          ...
          <Route
            path="ChiTietChiDoan/DoanVien"
            element={<DoanVien />}
          />
          <Route path="ThemMoi-DoanVien" element={<ThemMoiDoanVien />} />


          <Route path="DanhSachBCH" element={<DanhSachBCH />} />
          <Route
            path="DanhSachBCH/DoanVien"
            element={<BanChapHanh />}
          />
        ...
        <Route path="/ChiDoan" element={<BCH />}>
          ...
          <Route
            path="DanhSachBCH/:IDDoanVien/:IDChiTietNamHoc"
            element={<CDBanChapHanh />}
          />
