...
const DoanVien = (props) => {
  ...
  const handleSaveChanges = async (e) => {
    ...
    const newErrors = {
      ...
      MSSV: !MSSV || MSSV.trim() === "" ? "Vui lòng nhập mã cán bộ" : "",
      SoDT:
        !SoDT.trim() === ""
    ...
    try {
      ...
      formData.append("MaBCH", MSSV);
      formData.append("TenBCH", HoTen);
      formData.append("GioiTinhBCH", GioiTinh);
      formData.append("EmailBCH", Email);
      formData.append("SoDTBCH", SoDT);
      formData.append("IDDanToc", IDDanToc);
      formData.append("IDTonGiao", IDTonGiao);
      formData.append("NgaySinhBCH", NgaySinh);
      formData.append("NgayVaoDoanBCH", NgayVaoDoan);
      ...
      let res = await axios.post(
        "http://localhost:8080/api/ThemMoiBCH",
        formData
      );
        setShowModal(true);
      // setIsEditing(false);
  ...
  return (
    <>
      <div className="container-fluid app__content">
        <h2 className="text-center"> Thêm Ban Chấp Hành Trường</h2>
          ...
          <div className="row formAdd">
            ...
            <div className="col-12 col-md-9 col-lg-10 margin-top1">
              <div className="row">
                ...
                <div className="form-group col-12 col-md-6 col-lg-4">
                  <Form.Label htmlFor="MSSV">Mã cán bộ</Form.Label>
                ...
                <div className="form-group col-12 col-md-6 col-lg-4">
                  <Form.Label htmlFor="HoTen">Họ tên cán bộ</Form.Label>
