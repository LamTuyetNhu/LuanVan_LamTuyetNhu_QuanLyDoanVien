      ...
      <div className="listDV">
        <div className="table-container">
          <table className="table table-striped mb-table">
            <thead>
              <tr>
                ...
                <th>Điểm học kỳ 1</th>
                <th>Điểm học kỳ 2</th>
                <th>Điểm RL học kỳ 1</th>
                <th>Điểm RL học kỳ 2</th>
                <th className="table-item2">Đánh giá đoàn viên</th>
              </tr>
            </thead>
            <tbody id="myTable">
              {DSDoanVien &&
          ...
          <div className="searchDV-Right">
            ...
            bình: {DSPhanLoai[3] || 0} | Yếu kém: {DSPhanLoai[4] || 0} | Chưa
            phân loại: {DSPhanLoai[0] || 0}
          </div>
        <div>
        </div>
      </div>
